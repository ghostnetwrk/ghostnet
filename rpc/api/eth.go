...
import (
	...
	"github.com/ghostnetwrk/ghostnet/common"
	"github.com/ghostnetwrk/ghostnet/common/natspec"
	"github.com/ghostnetwrk/ghostnet/eth"
	"github.com/ghostnetwrk/ghostnet/rlp"
...
var (
	ethMapping = map[string]ethhandler{
        ...
        "gnt_accounts":                            (*ethApi).Accounts,
        "gnt_blockNumber":                         (*ethApi).BlockNumber,
        "gnt_getBalance":                          (*ethApi).GetBalance,
        "gnt_protocolVersion":                     (*ethApi).ProtocolVersion,
        "gnt_coinbase":                            (*ethApi).Coinbase,
        "gnt_mining":                              (*ethApi).IsMining,
        "gnt_syncing":                             (*ethApi).IsSyncing,
        "gnt_gasPrice":                            (*ethApi).GasPrice,
        "gnt_getStorage":                          (*ethApi).GetStorage,
        "gnt_storageAt":                           (*ethApi).GetStorage,
        "gnt_getStorageAt":                        (*ethApi).GetStorageAt,
        "gnt_getTransactionCount":                 (*ethApi).GetTransactionCount,
        "gnt_getBlockTransactionCountByHash":      (*ethApi).GetBlockTransactionCountByHash,
        "gnt_getBlockTransactionCountByNumber":    (*ethApi).GetBlockTransactionCountByNumber,
        "gnt_getUncleCountByBlockHash":            (*ethApi).GetUncleCountByBlockHash,
        "gnt_getUncleCountByBlockNumber":          (*ethApi).GetUncleCountByBlockNumber,
        "gnt_getData":                             (*ethApi).GetData,
        "gnt_getCode":                             (*ethApi).GetData,
        "gnt_getNatSpec":                          (*ethApi).GetNatSpec,
        "gnt_sign":                                (*ethApi).Sign,
        "gnt_sendRawTransaction":                  (*ethApi).SubmitTransaction,
        "gnt_submitTransaction":                   (*ethApi).SubmitTransaction,
        "gnt_sendTransaction":                     (*ethApi).SendTransaction,
        "gnt_signTransaction":                     (*ethApi).SignTransaction,
        "gnt_transact":                            (*ethApi).SendTransaction,
        "gnt_estimateGas":                         (*ethApi).EstimateGas,
        "gnt_call":                                (*ethApi).Call,
        "gnt_flush":                               (*ethApi).Flush,
        "gnt_getBlockByHash":                      (*ethApi).GetBlockByHash,
        "gnt_getBlockByNumber":                    (*ethApi).GetBlockByNumber,
        "gnt_getTransactionByHash":                (*ethApi).GetTransactionByHash,
        "gnt_getTransactionByBlockNumberAndIndex": (*ethApi).GetTransactionByBlockNumberAndIndex,
        "gnt_getTransactionByBlockHashAndIndex":   (*ethApi).GetTransactionByBlockHashAndIndex,
        "gnt_getUncleByBlockHashAndIndex":         (*ethApi).GetUncleByBlockHashAndIndex,
        "gnt_getUncleByBlockNumberAndIndex":       (*ethApi).GetUncleByBlockNumberAndIndex,
        "gnt_getCompilers":                        (*ethApi).GetCompilers,
        "gnt_compileSolidity":                     (*ethApi).CompileSolidity,
        "gnt_newFilter":                           (*ethApi).NewFilter,
        "gnt_newBlockFilter":                      (*ethApi).NewBlockFilter,
        "gnt_newPendingTransactionFilter":         (*ethApi).NewPendingTransactionFilter,
        "gnt_uninstallFilter":                     (*ethApi).UninstallFilter,
        "gnt_getFilterChanges":                    (*ethApi).GetFilterChanges,
        "gnt_getFilterLogs":                       (*ethApi).GetFilterLogs,
        "gnt_getLogs":                             (*ethApi).GetLogs,
        "gnt_hashrate":                            (*ethApi).Hashrate,
        "gnt_getWork":                             (*ethApi).GetWork,
        "gnt_submitWork":                          (*ethApi).SubmitWork,
        "gnt_submitHashrate":                      (*ethApi).SubmitHashrate,
        "gnt_resend":                              (*ethApi).Resend,
        "gnt_pendingTransactions":                 (*ethApi).PendingTransactions,
        "gnt_getTransactionReceipt":               (*ethApi).GetTransactionReceipt,
	}
)
