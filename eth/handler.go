...
import (
	...
	"github.com/ghostnetwrk/ghostnet/eth/fetcher"
	...
	"github.com/ghostnetwrk/ghostnet/pow"
...
func (pm *ProtocolManager) removePeer(id string) {
	...
	// Unregister the peer from the downloader and Ghostnet peer set
...
func (pm *ProtocolManager) Stop() {
	...
	glog.V(logger.Info).Infoln("Stopping Ghostnet protocol handler...")
	...
	glog.V(logger.Info).Infoln("Ghostnet protocol handler stopped")
}
