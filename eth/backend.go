...
import (
	...
	"github.com/ghostnetwrk/ghostnet/common/compiler"
	"github.com/ghostnetwrk/ghostnet/common/httpclient"
	"github.com/ghostnetwrk/ghostnet/core"
	"github.com/ghostnetwrk/ghostnet/core/state"
	"github.com/ghostnetwrk/ghostnet/core/types"
	"github.com/ghostnetwrk/ghostnet/core/vm"
	"github.com/ghostnetwrk/ghostnet/crypto"
	"github.com/ghostnetwrk/ghostnet/eth/downloader"
	"github.com/ghostnetwrk/ghostnet/ethdb"
	"github.com/ghostnetwrk/ghostnet/event"
	"github.com/ghostnetwrk/ghostnet/logger"
	"github.com/ghostnetwrk/ghostnet/logger/glog"
	"github.com/ghostnetwrk/ghostnet/miner"
	"github.com/ghostnetwrk/ghostnet/p2p"
	"github.com/ghostnetwrk/ghostnet/p2p/discover"
	"github.com/ghostnetwrk/ghostnet/p2p/nat"
	"github.com/ghostnetwrk/ghostnet/rlp"
	"github.com/ghostnetwrk/ghostnet/whisper"
)
...
func New(config *Config) (*Ethereum, error) {
	...
	if !config.SkipBcVersionCheck {
		...
		if bcVersion != config.BlockChainVersion && bcVersion != 0 {
			return nil, fmt.Errorf("Blockchain DB version mismatch (%d / %d). Run ghostnet upgradedb.\n", bcVersion, config.BlockChainVersion)
		}
...
func (s *Ethereum) Etherbase() (eb common.Address, err error) {
	...
	if (eb == common.Address{}) {
		...
		if e != nil {
			err = fmt.Errorf("ghostbase address must be explicitly specified")
		}
