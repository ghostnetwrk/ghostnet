...
)](https://godoc.org/github.com/ghostnetwrk/ghostnet) 
[![Gitter](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/ethereum/go-ethereum?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge)

## Automated development builds

The following builds are build automatically by our build servers after each push to the [develop](https://github.com/ghostnetwrk/ghostnet/tree/develop) branch.
...
[Installation Instructions](https://github.com/ghostnetwrk/ghostnet/wiki/Building-Ethereum)
on the wiki.
...
[the `cmd` directory](https://github.com/ghostnetwrk/ghostnet/tree/develop/cmd):
...
For further details on options, see the [wiki](https://github.com/ghostnetwrk/ghostnet/wiki/Command-Line-Options)
...
See [Developers' Guide](https://github.com/ghostnetwrk/ghostnet/wiki/Developers'-Guide)
